...
*/
databaseRouter.post("/index", requireAuthMiddleware, async (req: express.Request, res: express.Response) => {
...
databaseRouter.delete("index", requireAuthMiddleware, async (req, res) => {
